...
| `anonymous_vpn`     | `[traits][anonymous_vpn]`     | `false`
| `hosting_provider`  | `[traits][hosting_provider]`  | `true`
| `network`           | `[traits][network]`           | `12.34.56.78/20`
| `public_proxy`      | `[traits][public_proxy]`      | `true`
| `residential_proxy` | `[traits][residential_proxy]` | `false`
| `tor_exit_node`     | `[traits][tor_exit_node]`     | `true`
